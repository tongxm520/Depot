...
describe OrdersController do
  ...
  #https://github.com/rspec/rspec-rails/issues/1201
  #if :each replaced by :all,errors will occur
  before(:each) do
    user=users(:one)
    login_admin(user)
  ...
  def valid_attributes
    {:name=>"dacy",:email=>"dacy@gmail.com",:address=>"上海浦东新区",:pay_type=>"Check"}
  end
